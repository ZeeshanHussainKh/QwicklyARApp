                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    progressDialog.dismiss();
                     if(task.isSuccessful()){
                         Toast.makeText(LoginActivityPage.this,"Succesfully Registered User", Toast.LENGTH_LONG).show();
                         Toast.makeText(LoginActivityPage.this,"Created", Toast.LENGTH_LONG).show();
                         startActivity(new Intent(getApplicationContext(), com.example.zeeshanhussain.qwicklyapppart1.MainActivity.class));                     }
                    }
                });
